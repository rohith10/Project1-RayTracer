...
__host__ __device__ float sphereIntersectionTest(staticGeom *sphere, int i, ray r, glm::vec3& intersectionPoint, glm::vec3& normal){
  
  float radius = .5;
        
  glm::vec3 ro = multiplyMV(sphere[i].inverseTransform, glm::vec4(r.origin,1.0f));
  glm::vec3 rd = glm::normalize(multiplyMV(sphere[i].inverseTransform, glm::vec4(r.direction,0.0f)));
  ...
  glm::vec3 realIntersectionPoint = multiplyMV(sphere[i].transform, glm::vec4(getPointOnRay(rt, t), 1.0));
  glm::vec3 realOrigin = multiplyMV(sphere[i].transform, glm::vec4(0,0,0,1));
...
__host__ __device__ float boxIntersectionTest(staticGeom *box, int i, ray r, glm::vec3& intersectionPoint, glm::vec3& normal)
{
	...
	transformedRay.origin = multiplyMV (box[i].inverseTransform, glm::vec4 (r.origin, 1.0));
	transformedRay.direction = glm::normalize (multiplyMV (box[i].inverseTransform, glm::vec4 (r.direction, 0.0)));
	...
	transposeBoxInvTransform.x.x = box[i].inverseTransform.x.x;	transposeBoxInvTransform.x.y = box[i].inverseTransform.y.x;	transposeBoxInvTransform.x.z = box[i].inverseTransform.z.x;	transposeBoxInvTransform.x.w = box[i].inverseTransform.w.x;
	transposeBoxInvTransform.y.x = box[i].inverseTransform.x.y;	transposeBoxInvTransform.y.y = box[i].inverseTransform.y.y;	transposeBoxInvTransform.y.z = box[i].inverseTransform.z.y;	transposeBoxInvTransform.y.w = box[i].inverseTransform.w.y;
	transposeBoxInvTransform.z.x = box[i].inverseTransform.x.z;	transposeBoxInvTransform.z.y = box[i].inverseTransform.y.z;	transposeBoxInvTransform.z.z = box[i].inverseTransform.z.z;	transposeBoxInvTransform.z.w = box[i].inverseTransform.w.z;
	transposeBoxInvTransform.w.x = box[i].inverseTransform.x.w;	transposeBoxInvTransform.w.y = box[i].inverseTransform.y.w;	transposeBoxInvTransform.w.z = box[i].inverseTransform.z.w;	transposeBoxInvTransform.w.w = box[i].inverseTransform.w.w;

	// Transform the intersection point & the normal to world space.
	intersectionPoint = multiplyMV (box[i].transform, intersectionPointInBodySpace);
